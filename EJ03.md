# <span style="color: #1D6F58; font-weight: bold;">Ejercicio 3 </span>


## <span style="color: #2A2929; font-weight: bold;">Enunciado del Problema:</span>
> Diseñe un programa que permita a una persona ingresar su año de nacimiento y el año actual para calcular su edad. El programa debe garantizar que el año actual sea mayor o igual al año de nacimiento y que ambos valores sean números positivos.
...
2. >  Luego, el programa verificará que ambos valores sean números positivos y que el año actual sea mayor o igual al año de nacimiento.
3. > Si se cumplen ambas condiciones, calculará la edad restando el año de nacimiento del año actual.
4. > Finalmente, mostrará la edad calculada al usuario.

## <span style="color: #2A2929; font-weight: bold;">Diagrama de Flujo de Datos (DFD):</span>
<p align="center">
  <img src="Imagenes/3.png"  width="600" height="400">
</p>

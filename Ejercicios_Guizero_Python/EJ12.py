    ...
    if anio_nacimiento.isdigit() and anio_actual.isdigit():
        ...
        if anio_nacimiento >= 0 and anio_actual >= 0:
            if anio_actual >= anio_nacimiento:
                # Calcular la edad
                edad = (anio_actual + 1) - anio_nacimiento
                texto_edad.value = (f"En el próximo año cumplira {edad} años.")
            else:
                texto_edad.value = ""
...
app = App("Ejercicio 12")

# Crear elementos
enunciado1 = Text(app, text="Ejercicio 12 \n")
enunciado2 = Text(app, "Calculadora de edad para el año proximo.")
